...
export function ZyraBrandMark({ tag = "gh", className }: ZyraBrandMarkProps) {
  return (
    <span className={`inline-flex min-w-0 items-center gap-2 ${className ?? ""}`}>
      <span className="truncate font-[family-name:var(--font-space-grotesk)] text-[1rem] font-bold tracking-tight text-cyan-700 min-[430px]:text-[1.08rem] sm:text-xl dark:text-cyan-300">
        zyra
      </span>
